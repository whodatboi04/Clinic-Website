			...
			<div class="table" style = "display:table;">
						...
						else
						{
							while($row = mysqli_fetch_assoc($result)){
								...
								echo		"<td>".$row['age']."</td>";
								echo		"<td>".$row["illness_code"]."</td>";
								echo		"<td style='background-color:#25bfcd;width:7%;'><a style='color:#fff' href='sys-consultationview.php?student_no=".$row['student_no']."&illness_code=".$row['illness_code']."&date_prepared=".$row['date_prepared']."'>Consult</a></td>";
								echo		"<td style='background-color:#ff4040;width:7%;'><a style='color:#fff'href = 'sys-consultation.php?consultation-delete=1&student_no=".$row['student_no']."&illness_code=".$row['illness_code']."&date_prepared=".$row['date_prepared']."' onclick=";?>"return confirm('Are you sure you want to delete?')"<?php echo ">Delete</a></td>";						
								echo		"</tr>";
